Citizen.CreateThread(function()
	while true do
		SetDiscordAppId(1005501940995727501)
		SetDiscordRichPresenceAsset('logo1')
        SetDiscordRichPresenceAssetText('Princess Dev , Rejoingnez-nous !')
        SetDiscordRichPresenceAssetSmall('logo2')
        SetDiscordRichPresenceAssetSmallText('https://discord.gg/princess-dev ')
		Citizen.Wait(60000)
	end
end)
Citizen.CreateThread(function()
