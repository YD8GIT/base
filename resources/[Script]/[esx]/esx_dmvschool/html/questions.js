var tableauQuestion = [
	...
	{
		question: "Vous vous apprêtez à tourner à droite au feu vert, mais vous voyez un piéton qui traverse :",
		propositionA: "Vous passez avant le piéton",
		propositionB: "Vous vérifiez qu'il n'y a pas d'autres véhicules et vous passez",
		propositionC: "Vous attendez que le piéton ait terminé",
	...
	{
		question: "Quel est le taux d'alcool maximum autorisé lorsque vous prenez le volant ?",
		propositionA: "0.05%",
		propositionB: "0.18%",
		propositionC: "0.08%",
		propositionD: "0.06%",
	...
	{
		question: "Un piéton est au feu rouge",
	...
	{
		question: "Qu'est ce qui est permis lorsque vous dépassez un autre véhicule",
